...
export function WithdrawView({ userId, username, availableBalance }: WithdrawViewProps) {
  ...
  const handleWithdraw = async () => {
    ...
    // after getting idToken (in dynamic import section) and before createWithdrawalRequest call:
    const autoApprove = parsedAmount <= localBalance // client-side pre-check
